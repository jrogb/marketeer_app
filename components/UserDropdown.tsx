...
const UserDropdown = () => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuItem onClick={handleSignOut} className="text-gray-100 text-md font-medium focus:bg-transparent hover:bg-gray-700 focus:text-yellow-500 transition-colors cursor-pointer">
